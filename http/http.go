...
func (caller *HttpTransport) Call(api uint8, method string, args []interface{}, reply interface{}) error {
	// increase request id
...
func (caller *HttpTransport) SetCallback(api uint8, method string, notice func(args json.RawMessage)) error {
	return nil
}
